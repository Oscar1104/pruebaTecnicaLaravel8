...
@section('contenido')
    <h2 style="margin: 1rem; padding: 1rem; text-align: center;">CREAR CONDUCTOR</h2>
    ...
    <form action="/conductor" style="max-width: 420px; dysplay: block; margin: 0 auto" method="POST">
        @csrf
        <div class="mb-3">
